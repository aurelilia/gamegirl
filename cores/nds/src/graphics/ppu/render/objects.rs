...
use crate::graphics::ppu::CharacterMappingMode;
...
impl PpuRender {
    ...
    fn render_obj_normal(&mut self, obj: Object) {
        ...
        let tile_width = obj.tile_width(self.r.dispcnt.tile_obj_mode(), width);
        ...
        for screen_x in start..end {
            ...
            let tile_addr = base_addr
                + xy2dw(
                    ...
                    * tile_size;
            let palette = self.get_palette_obj(
                obj.palette(),
                obj.palette_mode(),
                tile_addr,
                sprite_x as u32 % 8,
    ...
    fn render_obj_affine(&mut self, obj: Object, double: bool) {
        ...
        let base_addr = 0x1_0000 + (0x20 * obj.tilenum().u32());
        let tile_width = obj.tile_width(self.r.dispcnt.tile_obj_mode(), width as u16);
        let tile_size = obj.tile_size();
